			...
			<el-tab-pane lazy label="Global Setting" v-loading="loading">
				<el-card>
					<el-form label-position="left" label-width="270px">
						...
						<el-form-item
							label="Mode Buka Gate Untuk Staff"
							:class="formErrors.staff_buka_otomatis ? 'is-error' : ''"
						>
							<el-select
								placeholder="Mode Buka Gate Untuk Staff"
								v-model="formModel.staff_buka_otomatis"
								style="width: 100%"
							>
								<el-option
									v-for="(l, i) in [
							...
							<div
								class="el-form-item__error"
								v-if="formErrors.staff_buka_otomatis"
							>
								{{ formErrors.staff_buka_otomatis[0] }}
							</div>
						</el-form-item>

						<el-form-item
							label="Mode Buka Gate Untuk Pengunjung"
							:class="formErrors.pengunjung_buka_otomatis ? 'is-error' : ''"
						>
							<el-select
								placeholder="Mode Buka Gate Untuk Pengunjung"
								v-model="formModel.pengunjung_buka_otomatis"
								style="width: 100%"
							>
								<el-option
									v-for="(l, i) in [
										'Ketik Plat Nomor (Buka oleh operator)',
										'Tempel Tiket (Otomatis)',
									]"
									:key="i"
									:value="i"
									:label="l"
							...
							<div
								class="el-form-item__error"
								v-if="formErrors.pengunjung_buka_otomatis"
							>
								{{ formErrors.pengunjung_buka_otomatis[0] }}
							</div>
						</el-form-item>
						...
						<el-form-item
							label="Hapus Log dalam x hari"
							:class="formErrors.hapus_log_dalam_hari ? 'is-error' : ''"
						>
							<el-input
								type="number"
								placeholder="Hapus Transaksi dalam x hari"
								v-model="formModel.hapus_log_dalam_hari"
							></el-input>
							<div
								class="el-form-item__error"
								v-if="formErrors.hapus_log_dalam_hari"
							>
								{{ formErrors.hapus_log_dalam_hari[0] }}
							</div>
						</el-form-item>
					</el-form>
					<el-button
