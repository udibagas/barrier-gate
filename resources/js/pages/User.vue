    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          >{{scope.row.expired ? 'KEDALUARSA' : 'BERLAKU'}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="name"
      ...
      <el-table-column
        ...
        width="120px"
      >
        <template slot-scope="scope">{{roles[scope.row.role]}}</template>
      </el-table-column>
      ...
      <el-table-column
        label="Masa Aktif Kartu"
        sortable="custom"
        width="150px"
        align="center"
        header-align="center"
      >
        <template slot-scope="scope">{{scope.row.masa_aktif_kartu | readableDate}}</template>
      </el-table-column>
      ...
      <el-table-column
        ...
        show-overflow-tooltip
      ></el-table-column>
      <el-table-column prop="nomor_hp" label="Nomor HP" sortable="custom" width="120px"></el-table-column>
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                @click.native.prevent="showDetail = true; user = scope.row;"
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            ...
            <el-form-item label="Jenis Kelamin" :class="formErrors.jenis_kelamin ? 'is-error' : ''">
              <el-select
                v-model="formModel.jenis_kelamin"
                placeholder="Jenis Kelamin"
                style="width:100%"
              >
                <el-option
                  v-for="(t, i) in [{value: 'L', label: 'LAKI - LAKI'}, {value: 'P', label: 'PEREMPUAN'}]"
                  :value="t.value"
                  :label="t.label"
                  :key="i"
                ></el-option>
              ...
              >{{formErrors.jenis_kelamin[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Tempat Lahir" :class="formErrors.tempat_lahir ? 'is-error' : ''">
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.tempat_lahir"
              >{{formErrors.tempat_lahir[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Tanggal Lahir" :class="formErrors.tanggal_lahir ? 'is-error' : ''">
              <el-date-picker
                ...
                v-model="formModel.tanggal_lahir"
              ></el-date-picker>
              <div
                class="el-form-item__error"
                v-if="formErrors.tanggal_lahir"
              >{{formErrors.tanggal_lahir[0]}}</div>
            </el-form-item>
          ...
          <el-col :span="8">
            ...
            <el-form-item label="Nomor HP" :class="formErrors.nomor_hp ? 'is-error' : ''">
              <el-input placeholder="Nomor HP" v-model="formModel.nomor_hp"></el-input>
              <div class="el-form-item__error" v-if="formErrors.nomor_hp">{{formErrors.nomor_hp[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Departemen" :class="formErrors.department_id ? 'is-error' : ''">
              ...
              >
                <el-option
                  v-for="(d, i) in $store.state.departmentList"
                  :value="d.id"
                  :label="d.nama"
                  :key="i"
                ></el-option>
            ...
            <el-form-item label="Level" :class="formErrors.role ? 'is-error' : ''">
              <el-select v-model="formModel.role" placeholder="Level" style="width:100%">
                <el-option
                  v-for="(t, i) in [{value: 0, label: 'STAFF'}, {value: 1, label: 'OPERATOR'}, {value: 2, label: 'ADMIN'}]"
                  :value="t.value"
                  :label="t.label"
                  :key="i"
                ></el-option>
          ...
          <el-col :span="8">
            <el-form-item label="Nomor Kartu" :class="formErrors.nomor_kartu ? 'is-error' : ''">
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.nomor_kartu"
              >{{formErrors.nomor_kartu[0]}}</div>
            </el-form-item>

            <el-form-item
              label="Masa Aktif Kartu"
              :class="formErrors.masa_aktif_kartu ? 'is-error' : ''"
            >
              <el-date-picker
                style="width:100%"
                format="dd-MMM-yyyy"
                value-format="yyyy-MM-dd"
                placeholder="Masa Aktif Kartu"
                v-model="formModel.masa_aktif_kartu"
              ></el-date-picker>
              <div
                class="el-form-item__error"
                v-if="formErrors.masa_aktif_kartu"
              >{{formErrors.masa_aktif_kartu[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Plat Nomor" :class="formErrors.plat_nomor ? 'is-error' : ''">
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.plat_nomor"
              >{{formErrors.plat_nomor[0]}}</div>
            </el-form-item>
          ...
          <tr>
            ...
            <td class="value">
              <el-tag
                ...
                effect="dark"
              >{{user.status ? 'AKTIF' : 'NONAKTIF'}}</el-tag>
            </td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  methods: {
    ...
    download() {
      ...
      axios
        .get("user", { params: Object.assign(params, this.filters) })
        .then(r => {
