<template>
	<div>
		...
		>
			...
			<el-table-column
				:filters="[
					{ value: 'berlaku', text: 'BERLAKU' },
					{ value: 'kedaluarsa', text: 'KEDALUARSA' },
				]"
				:filter-multiple="false"
				column-key="expired"
				prop="expired"
			...
			<el-table-column
				:filters="
					$store.state.departmentList.map((d) => {
						return { value: d.id, text: d.nama };
					})
				"
			...
			<el-form label-width="160px" label-position="left">
				<el-row :gutter="20">
					<el-col :span="8">
						...
						<el-form-item
							label="Jenis Kelamin"
							:class="formErrors.jenis_kelamin ? 'is-error' : ''"
						>
							<el-select
						...
						<el-form-item
							label="Tempat Lahir"
							:class="formErrors.tempat_lahir ? 'is-error' : ''"
						>
							<el-input
								placeholder="Tempat Lahir"
								v-model="formModel.tempat_lahir"
							></el-input>
							<div class="el-form-item__error" v-if="formErrors.tempat_lahir">
						...
						<el-form-item
							label="Tanggal Lahir"
							:class="formErrors.tanggal_lahir ? 'is-error' : ''"
						>
							<el-date-picker
								style="width: 100%"
								format="dd-MMM-yyyy"
							...
							></el-date-picker>
							<div class="el-form-item__error" v-if="formErrors.tanggal_lahir">
					...
					<el-col :span="8">
						...
						<el-form-item
							label="Nomor HP"
							:class="formErrors.nomor_hp ? 'is-error' : ''"
						>
							<el-input
								placeholder="Nomor HP"
								v-model="formModel.nomor_hp"
							></el-input>
							<div class="el-form-item__error" v-if="formErrors.nomor_hp">
						...
						<el-form-item label="NIP" :class="formErrors.nip ? 'is-error' : ''">
							...
							<div class="el-form-item__error" v-if="formErrors.nip">
								{{ formErrors.nip[0] }}
							</div>
						</el-form-item>
						...
						<el-form-item
							label="Departemen"
							:class="formErrors.department_id ? 'is-error' : ''"
						>
							<el-select
								clearable
								filterable
							...
							<div class="el-form-item__error" v-if="formErrors.department_id">
			...
			<table class="table table-sm">
				<tbody>
					...
					<tr>
						...
						<td class="value">
							{{ user.tempat_lahir }}/{{ user.tanggal_lahir | readableDate }}
						</td>
					</tr>
					<tr>
