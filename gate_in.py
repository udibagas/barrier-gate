...
def print_ticket_network(data):
    ...
    try:
        ...
        p.set(align='center')
        p.barcode(data['nomor_barcode'], 'CODE39', function_type='A', height=100, width=4, pos='BELOW', align_ct=True)
        p.text("\n")
...
def gate_in_thread():
    while True:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            logging.info('Connecting to ' + GATE['controller_ip_address'] + ':' + str(GATE['controller_port']))
            ...
            while True:
                ...
                while True:
                    ...
                    logging.debug('Detecting button or card ' + str(push_button_or_card))
